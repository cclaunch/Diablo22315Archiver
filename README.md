...
The PCB connects to the FPGA board, prrovides power to the FPGA and the logic on the PCB, and connects to the Diablo disk drive using an IDC 50 pin cable.
